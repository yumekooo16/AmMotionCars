...
export default function ServicePremium() {
  ...
  return (
    ...
    >
      {/* Image plein écran */}
      <img
        src="./image/ManGT43.jpeg"
        alt="Service Premium — Chauffeur privé Paris"
      ...
      <div className="absolute bottom-0 left-0 right-0 px-8 md:px-14 pb-14 md:pb-20 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
        <div>
          ...
          <p className="text-sm font-light text-white/45 max-w-md leading-relaxed">
            Un chauffeur en tenue, un véhicule préparé, une ponctualité absolue.
            Pour chaque déplacement professionnel ou privé à Paris et en Île-de-France.
          </p>
        </div>
        <Link
          href="/services"
