        ...
        <form onSubmit={handleSubmit} className="p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 overflow-x-hidden overscroll-behavior-x-none">
            <div>
              ...
              <input
                ...
                required
                className="md-w-75 px-4 py-3 border-2 border-gray-700 bg-gray-800 text-white rounded-lg focus:border-[#5f6364] focus:outline-none"
          ...
          <div className="mb-6">
            ...
            <input
              ...
              onChange={handleChange}
              required
              className="md-w-80 px-4 py-3 border-2 border-gray-700 bg-gray-800 text-white rounded-lg focus:border-[#5f6364] focus:outline-none"
          ...
          <div className="mb-6">
            ...
            <input
              ...
              onChange={handleChange}
              required
              className="md-md-w-80 px-4 py-3 border-2 border-gray-700 bg-gray-800 text-white rounded-lg focus:border-[#5f6364] focus:outline-none"
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="4"
              className="md-w-80 px-4 py-3 border-2 border-gray-700 bg-gray-800 text-white rounded-lg focus:border-[#5f6364] focus:outline-none resize-none"
